...
public class HomeLiveRequest {
    ...
    public HomeLiveRequest(int page, int max, String grade, String lokasi, int tahunStart, int tahunEnd, long hargaStart, long hargaEnd, String merek, String category) {
        this.page = page;
        this.max = max;
        this.grade = grade;
        this.lokasi = lokasi;
