...
public class InternetX {
    ...
    public static String getSetting(String key){
        return UtilityAndroid.getSetting(GrosirMobilApp.getInstance(), key, "");
    }
    public static void setSetting(String key, String value){
        UtilityAndroid.setSetting(GrosirMobilApp.getInstance(), key, value);
    }
    ...
    public static void sendBroadcastIfUnauthorized401(int HttpResult){
        if (HttpResult == 401){
            ...
            //GrosirMobilApp.getInstance().sendBroadcast(intent);
